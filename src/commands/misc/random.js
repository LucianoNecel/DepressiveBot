...
module.exports = {
  ...
  callback: async (client, interaction) => {
    ...
    if (minimo >= maximo) {
      ...
      await interaction.editReply({ content: 'El valor mínimo debe ser menor que el valor máximo.', ephemeral: true });
      return;
    } else {
    ...
    await interaction.editReply({ content: `Número aleatorio entre ${minimo} y ${maximo}: ${numeroAleatorio}`, ephemeral: false });
  },
};